...
<form action="{{ route('pedidos.update', $pedidos->id) }}" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="nombreCliente" name="nombreCliente" placeholder="nombreCliente" value="{{ $pedidos->nombreCliente }}" required>
        ...
        <div class="col-md-6">
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="productos_id" name="productos_id" placeholder="productos_id" disabled>
                    <label for="disabledTextInput" value="">{{ $productos->nombre }}</label>
            </div>
        </div> 
    </div>
    ...
    <div class="form-floating mb-3">
        <input type="number" class="form-control" id="precio" name="precio" placeholder="precio" disabled>
            <label for="disabledNumberInput" value="">{{ $productos->precio }}</label>
    </div>
